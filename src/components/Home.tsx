...
import { Users, MessageCircle, Code2, ChevronRight } from 'lucide-react';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faGithub, faMedium, faReddit } from '@fortawesome/free-brands-svg-icons';
import heroNathan from '../assets/images/nathan_b.jpg';
            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="h-[32rem] bg-gray-100 dark:bg-gray-800">
                    <div className="container px-6 py-10 mx-auto">
                        ...
                        <p className="max-w-2xl mx-auto mt-6 text-center text-gray-500 dark:text-gray-300">
                            Our team is made up of passionate Python developers who are dedicated to helping others learn and grow.
                        </p>
                    </div>
                </div>
                ...
                <div className="container px-6 py-10 mx-auto -mt-72 sm:-mt-80 md:-mt-96">
                    <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3">
                        <div className="flex flex-col items-center p-4 border sm:p-6 rounded-xl bg-[#213950] dark:border-gray-700 transition ease-in-out delay-100 hover:rotate-3">
                            <img className="object-cover w-full rounded-xl aspect-square" src={ heroNathan } alt=""/>

                            <h1 className="mt-4 text-2xl font-semibold text-[#ffde57] capitalize dark:text-white">nathan bransby</h1>
                            <p className="mt-2 text-white capitalize dark:text-gray-300">py versify founder & Mentor</p>
                            <p className="mt-2 text-gray-300 capitalize italic dark:text-gray-300">Diversity & Inclusion - The Python Software Foundation</p>

                            <div className="flex mt-3 -mx-2">
                                
                                <a 
                                  href="https://github.com/sponsors/Nathan-Bransby-NMT" 
                                  className="mx-2 text-white transition-colors duration-300 dark:text-gray-300 hover:text-[#ffde57] dark:hover:text-blue-400" 
                                  aria-label="Github">
                                    <FontAwesomeIcon icon={faGithub} />
                                </a>
                                
                                <a href="https://nathan-bransby.medium.com/" className="mx-2 text-white transition-colors duration-300 dark:text-gray-300 hover:text-[#ffde57] dark:hover:text-blue-400" aria-label="Medium">
                                    <FontAwesomeIcon icon={faMedium} />
                                </a>

                                <a href="https://www.reddit.com/user/__dunder__mifflin__/" className="mx-2 text-white transition-colors duration-300 dark:text-gray-300 hover:text-[#ffde57] dark:hover:text-blue-400" aria-label="Reddit">
                        ...
                        <div className="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700 transition ease-in-out delay-100 hover:-rotate-3">
                            ...
                            <h1 className="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white">Jane Doe</h1>

                            <p className="mt-2 text-gray-500 capitalize dark:text-gray-300">NoBody</p>
