...
import { faSlack, faDiscord, faGithub, faMastodon } from '@fortawesome/free-brands-svg-icons';
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-300 flex flex-col">
      {/* Header */}
      <header className="bg-[#4584b6] text-white">
        <div className="container mx-auto px-6 py-4">
          <nav className="flex items-center justify-between">
            ...
            <div className="hidden md:flex space-x-8">
              <a href="#community" className="hover:text-[#ffde57] transition-colors">Community</a>
              <a href="#resources" className="hover:text-[#ffde57] transition-colors">Resources</a>
              <a href="#join" className="hover:text-[#ffde57] transition-colors">Join Us</a>
            </div>
          </nav>
        </div>
      </header>
          ...
          <div className="container px-6 py-10 mx-auto -mt-72 sm:-mt-80 md:-mt-96">
              <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3">
                  <div className="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
                      ...
                      <h1 className="mt-4 text-2xl font-semibold text-gray-900 capitalize dark:text-white">nathan bransby</h1>
                      <p className="mt-2 text-gray-700 capitalize dark:text-gray-300">py versify founder & Mentor</p>
                      <p className="mt-2 text-gray-400 capitalize italic dark:text-gray-300">Diversity & Inclusion - The Python Software Foundation</p>
        ...
        <div className="py-16 md:py-20 mx-auto w-full max-w-7xl px-5 md:px-10">
          ...
          <div className="flex items-center space-x-2 mb-4 md:mb-0 pb-10">
            ...
            <div className="text-center font-semibold">
              <a href="#" className="inline-block px-6 py-2 font-normal text-white transition hover:text-[#ffde57]">
                About
              </a>
              <a href="#" className="inline-block px-6 py-2 font-normal text-white transition hover:text-[#ffde57]">
                Features
            ...
            <div className="mb-12 grid-cols-4 grid-flow-col grid max-w-52 gap-8 mx-auto">
              ...
              <a href="#" className="mx-auto flex-col flex max-w-6 items-center justify-center text-white">
                <FontAwesomeIcon icon={faSlack} color='#ffffff' />
              </a>
              {/* GitHub */}
              ...
              {/* Discord */}
              <a href="#" className="mx-auto flex-col flex max-w-6 items-center justify-center text-black">
                <FontAwesomeIcon icon={faDiscord} color='#ffffff' />
              </a>
              {/* Mastodon */}
              <a href="#" className="mx-auto flex-col flex max-w-6 items-center justify-center text-black">
